                ...
                components={{
                    code({ inline, className, children, ...props }: CodeProps) {
                        ...
                        return !inline && match ? (
                            ...
                            <code
                                className={`bg-muted text-foreground border border-border/60 px-1 py-0.5 rounded text-sm ${className}`}
                                {...props}
                            >
                                {children}
                            </code>
                    ...
                    h1({ children, ...props }) {
                        return (
                            <h1
                                className="text-brand-gradient text-responsive-title font-bold text-center my-8 pb-2 border-b-2 border-border animate-glow"
                                {...props}
                            >
                                {children}
                            </h1>
